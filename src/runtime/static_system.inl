...
template<typename T, typename...Components> 
StaticSystem<T, Components...>* create_static_system(int32_t id, 
                                                     T* system, 
                                                     void (T::*)(Context*, int32_t id, Components*...)  ) {
  return new StaticSystem<T,Components...>(id, system);
}

template<typename TSystem, typename...TArgs>
auto create_static_system(int32_t id, TArgs&&...args) {
